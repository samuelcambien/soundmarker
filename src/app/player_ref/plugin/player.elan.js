...
Player.ELAN = {
    ...
    render: function () {
        ...
        table.className = 'player-annotations';
        ...
        indeces.forEach(function (index) {
            ...
            var th = document.createElement('th');
            th.className = 'player-tier-' + tier.id;
        ...
        this.renderedAlignable.forEach(function (alignable) {
            ...
            row.id = 'player-alignable-' + alignable.id;
    ...
    getAnnotationNode: function (annotation) {
        return document.getElementById(
            'player-alignable-' + annotation.id
        );
    }
};

Player.util.extend(Player.ELAN, Player.Observer);
