...
//     this.params = Player.util.extend({}, this.defaultParams, params);
//
...
//     var my = this;
//
//     this.drawer = Object.create(Player.Drawer[this.params.renderer]);
...
//     }
//
//     if (this.params.backend == 'WebAudio' && !Player.WebAudio.supportsWebAudio()) {
//       this.params.backend = 'MediaElement';
//     }
//
...
//
//   getId() {
//     return 'player_' + Math.random().toString(32).substring(2);
//   },
//
//   ajax(options) {
//     var ajax = Object.create(Player.Observer);
...
// };
//
// /* Make the main Player object an observer */
// Player.util.extend(Player, Player.Observer);
//
// 'use strict';
//
// Player.WebAudio = {
...
//     if (!Player.WebAudio.offlineAudioContext) {
//       Player.WebAudio.offlineAudioContext = new (
//         window.OfflineAudioContext || window.webkitOfflineAudioContext
//       )(1, 2, sampleRate);
//     }
//     return Player.WebAudio.offlineAudioContext;
//   },
//
//   init(params) {
//     this.params = params;
...
//
//     this.states = [
//       Object.create(Player.WebAudio.state.playing),
//       Object.create(Player.WebAudio.state.paused),
//       Object.create(Player.WebAudio.state.finished)
//     ];
//
...
//     this.analyser.disconnect();
//     // close the audioContext if it was created by player
...
//     this.lastPlay = this.ac.currentTime;
//
//     this.createSource(this.sources[0]);
//   },
//
//   loadBuffer(index) {
//
...
//         this.readResponse(response.body.getReader(), array, 0, (completeArray) => {
//           this.audioBuffers[index] = Player.copy(completeArray.buffer);
//           this.decodeBuffer(index, completeArray.buffer, callback);
//         });
//       });
//   },
//
//   createSource(source) {
//     this.disconnectSource();
//     source = this.ac.createBufferSource();
//
...
// };
//
// Player.WebAudio.state = {};
//
// Player.WebAudio.state.playing = {
//   init() {
...
// };
//
// Player.WebAudio.state.finished = {
//   init() {
//     this.removeOnAudioProcess();
...
// };
//
// Player.util.extend(Player.WebAudio, Player.Observer);
//
// 'use strict';
//
// Player.MediaElement = Object.create(Player.WebAudio);
//
// Player.util.extend(Player.MediaElement, {
//   init(params) {
//     this.params = params;
//
...
// Player.AudioElement = Player.MediaElement;
//
// 'use strict';
//
// Player.Drawer = {
...
// 'use strict';
//
// Player.Drawer.Canvas = Object.create(Player.Drawer);
//
// Player.util.extend(Player.Drawer.Canvas, {
//   createElements() {
...
//       var max = Player.util.max(peaks);
//       var min = Player.util.min(peaks);
...
// 'use strict';
//
// Player.Drawer.MultiCanvas = Object.create(Player.Drawer);
//
// Player.util.extend(Player.Drawer.MultiCanvas, {
//
//   initDrawer(params) {
...
//
//     if (!this.player) {
//       throw Error('No Player instance provided');
//     }
//
//     var drawer = this.drawer = this.player.drawer;
//
//     this.container = 'string' == typeof params.container ?
//       document.querySelector(params.container) : params.container;
//
//     if (!this.container) {
//       throw Error('No container for Player timeline');
//     }
//
...
//     //   timeLine.fireEvent('click', e, player.drawer.handleEvent(e, false));
//     // });
//
...
//     }.bind(this));
//
//     this._onRedraw = player.on('redraw', this.render.bind(this));
//     this._onZoom = player.on('zoom', this.render.bind(this));
//     this._onDestroy = player.on('destroy', this.destroy.bind(this));
//   },
//
//   destroy() {
//     // Unsubscribe from internal player events
//     this._onRedraw.un();
//     this._onZoom.un();
//     this._onDestroy.un();
//
...
//     }
//
//     var wsParams = this.player.params;
//     this.wrapper = this.container.appendChild(
...
// };
//
// Player.util.extend(Player.Timeline, Player.Observer);
