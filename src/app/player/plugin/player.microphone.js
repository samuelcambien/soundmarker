...
Player.Microphone = {
    init: function (params) {
        ...
        // player's AudioContext where we'll route the mic signal to
        this.micContext = this.player.backend.getAudioContext();
    },
    ...
    reloadBuffer: function(event) {
        if (!this.paused) {
            this.player.empty();
            this.player.loadDecodedBuffer(event.inputBuffer);
        }
    },
...
Player.util.extend(Player.Microphone, Player.Observer);
